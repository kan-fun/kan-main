module github.com/kan-fun/kan-main

go 1.14

require (
	github.com/aliyun/alibaba-cloud-sdk-go v1.61.101
	...
	github.com/kan-fun/kan-server-core v0.0.0-20200412030421-b7596323f927
